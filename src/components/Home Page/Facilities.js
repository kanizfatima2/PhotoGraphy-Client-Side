...
const Facilities = () => {
    return (
        <div>
            <section className="dark:bg-gray-800 dark:text-gray-100 mb-8">
                <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50">All the Features you want</h2>
                        <p className="max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-400">Here you get the best things</p>
                    </div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        ...
                        <div aria-hidden="true" className="mt-10 lg:mt-0">
                            <img src="https://assets.vogue.in/photos/619354b7ea6acf01092aef93/master/pass/Rajkummar%20and%20Patralekhaa%20(2).jpg" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
                        </div>
                    </div>
                    <div>
